  ...
  while (i < lines.length) {
    ...
    if (ulMatch || olMatch) {
      ...
      if (ulMatch) {
        ...
        thisType = 'ol';
        contentText = (olMatch as RegExpMatchArray)[2].trim();
      }
      ...
      while (i < lines.length) {
        ...
        const isSameType = thisType === 'ul' ? !!nextUl : !!nextOl;
        if (!isSameType) break;
        const itemText = (thisType === 'ul' ? (nextUl as RegExpMatchArray)[1] : (nextOl as RegExpMatchArray)[2]).trim();
